...
globalkeys = gears.table.join(
    ...
    -- Audio Mixer TUI
    awful.key({ modkey,           }, "p", function () awful.spawn(pulsemixer) end,
...
local function move_to_previous_tag(c)
...
local function move_to_next_tag(c)
    local t = c.screen.selected_tag
    local tags = c.screen.tags
    local idx = t.index
    local newtag = tags[gmath.cycle(#tags, idx + 1)]
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "w",   move_to_previous_tag,
              {description = "move to previous tag", group = "client"}),
    awful.key({ modkey, "Shift"   }, "s",  move_to_next_tag,
